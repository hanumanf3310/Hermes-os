...
impl ProviderKind {
    ...
    pub fn default_model(&self) -> &'static str {
        match self {
            ...
            Self::Ollama => "ollama/qwen3.5:cloud",
    ...
    pub fn endpoint_env(&self) -> Option<&'static str> {
        match self {
            ...
            Self::OpenAIResponses => Some("OPENAI_BASE_URL"),
    ...
    pub fn endpoint_user_configurable(&self) -> bool {
        matches!(
            self,
            Self::OpenAI | Self::OpenAIResponses | Self::Ollama | Self::OllamaAnthropic
        )
    }
    ...
    pub fn default_endpoint(&self) -> Option<&'static str> {
        match self {
            ...
            Self::OpenAIResponses => Some("https://api.openai.com/v1/responses"),
...
mod tests {
    ...
    #[test]
    fn ollama_default_model_matches_cloud_fallback() {
        assert_eq!(ProviderKind::Ollama.default_model(), "ollama/qwen3.5:cloud");
    }
}
