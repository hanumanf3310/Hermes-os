...
class BasePlatformAdapter(ABC):
    ...
    async def handle_message(self, event: MessageEvent) -> None:
        ...
        if session_key in self._active_sessions:
            ...
            if cmd in ("approve", "deny", "status", "checkpoint", "stop", "new", "reset", "background", "restart", "reload-skills", "reload_skills", "hermes-os", "hermes_os", "hermes-memory-graph", "hermes_memory_graph", "hermes-workspace", "hermes_workspace", "workspace", "gemini-cli", "gemini_cli", "gemini-research", "gemini_research", "codegraph", "code_graph", "cg"):
                logger.debug(
