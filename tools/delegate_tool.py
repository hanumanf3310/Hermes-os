...
DELEGATE_TASK_SCHEMA = {
    ...
    "description": (
        ...
        "2. Batch (parallel): provide 'tasks' array with up to delegation.max_concurrent_children items (default 3, configurable via config.yaml). "
        "If the submitted tasks exceed the limit, delegate_task returns a tool error rather than truncating the batch. "
